  ...
  return (
    <section className="min-h-screen flex flex-col justify-center items-center px-6 pt-20 grid-overlay relative">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <h1 className="text-4xl md:text-6xl font-bold text-balance mb-8 leading-tight neon-text">
          ...
          <div className="relative max-w-2xl mx-auto mb-8">
            <div className="aspect-video bg-muted rounded-lg overflow-hidden group cursor-pointer border-2 border-primary/50 hover:border-primary transition-colors">
              <img
                src={
                  demoreel.videoUrl ||
                  "/placeholder.svg?height=400&width=600&query=retro video editor demo reel with neon effects"
                }
                alt={demoreel.title}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div className="text-center p-4 border border-primary/30 rounded-lg bg-card/50">
            <div className="text-2xl md:text-3xl font-bold mb-2 text-primary neon-text font-mono">
              {stats.videosEdited}
            </div>
            <div className="text-sm text-muted-foreground font-mono uppercase tracking-wide">VÍDEOS EDITADOS</div>
          </div>
          <div className="text-center p-4 border border-accent/30 rounded-lg bg-card/50">
            <div className="text-2xl md:text-3xl font-bold mb-2 text-accent neon-text font-mono">
              {stats.clientsServed}
            </div>
